    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/30 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground w-full max-w-sm">
          Get started by adding your first staff member to your team so they can
          be booked.
        </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(350px,1fr))] gap-6">
          ...
          return (
            <Card
              ...
              className={cn(
                ...
                isInactive && "opacity-75 grayscale hover:grayscale-0",
              )}
            >
              <CardContent className="p-5 pl-7 flex flex-col gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <Badge
                        ...
                        className={
                          member.isActive
                            ? "bg-emerald-100 text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-900/40 dark:text-emerald-400 dark:hover:bg-emerald-900/40 font-medium border-emerald-200 dark:border-emerald-800"
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {member.specialties.map((spec: string, i: number) => (
                        <Badge
                          ...
                          variant="outline"
                          className={cn(
                            "text-xs truncate max-w-[140px] font-normal",
                            isInactive
                ...
                <div className="mt-2 pt-6 border-t w-full">
                  <Button
                    ...
                    size="lg"
                    asChild
                    className="w-full text-xs hover:bg-primary/5 hover:text-primary hover:border-primary/30 shadow-m dark:shadow-m rounded-full dark:border-none transition-colors"
                  >
                  ...
                  {member.isActive ? (
                    <Button
                      ...
                      onClick={() => {
                        if (
                          confirm(
                            `Are you sure you want to deactivate ${member.displayName}?`,
                          )
                        )
                          deactivateStaffMember({ orgId, staffId: member._id });
                      }}
                    ...
                    <Button
                      ...
                      onClick={() => {
                        alert(
                          "Reactivate UI needs backend implementation or update",
                        );
                      }} // Assuming we need to implement Reactivation since deactivateStaffMember exists
        ...
        >
          ...
          <div className="flex flex-col gap-1 px-6">
            ...
            <p className="text-sm text-muted-foreground w-full max-w-[240px]">
              Expand your team by adding a new staff member.
            </p>
          </div>
        </button>
      </div>
