  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${focused ? "rgba(255,129,74,0.5)" : "rgba(255,255,255,0.12)"}`,
    ...
    >
      ...
      <button
        ...
        style={{
          background: hasValue ? "#ff814a" : "rgba(255,255,255,0.08)",
          boxShadow: hasValue ? "0 2px 8px rgba(255,129,74,0.5)" : "none",
        }}
      >
