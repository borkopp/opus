...
**Geographic focus**: Initially targeting **Macedonia** (Skopje), with localization for Macedonian language (MKD currency, Cyrillic AI responses).
...
+ future fintech. Currently targeting Macedonia (MKD currency, Macedonian language).
...
_Generated from codebase analysis on 2026-04-14. Cross-reference with the actual code for the latest state._
