    ...
    >
      <LampContainer>
        <div className="relative z-10 mx-auto flex flex-col items-center">
          <Heading
            as="h2"
            className="text-center text-2xl font-medium tracking-tight text-neutral-800 md:text-4xl dark:text-neutral-100"
          >
      ...
      <Container className="relative z-20 pb-12 md:pb-24">
        <div
          ref={containerRef}
          className="relative z-10 mx-auto grid w-full max-w-4xl grid-cols-1 items-stretch gap-6 p-2 sm:p-4 md:grid-cols-2"
        >
            ...
            >
              ...
              >
                ...
                <PricingCardUI.Body className="p-4 sm:p-5">
                  <PricingCardUI.List className="flex flex-col gap-3">
