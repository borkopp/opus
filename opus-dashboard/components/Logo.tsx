...
export const Logo = ({ className }: { className?: string }) => {
  return (
    <span className={cn("inline-flex items-center gap-2 text-[#ce5d45]", className)} aria-label="OPUS">
      ...
      <span className={cn(audiowide.className, "uppercase tracking-wider text-current")}>OPUS</span>
    </span>
  );
};
