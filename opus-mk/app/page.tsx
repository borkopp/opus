    ...
    <div className="dark h-[100dvh] bg-black relative overflow-hidden">
      ...
      <div
        className={`absolute inset-0 bg-cover bg-center transition-opacity duration-1000 md:hidden ${
          hasStarted ? "opacity-20" : "opacity-90"
        }`}
        style={{
      ...
      <div
        className={`absolute inset-0 bg-cover bg-center transition-opacity duration-1000 hidden md:block ${
          hasStarted ? "opacity-10" : "opacity-60"
        }`}
        style={{
